...
public class SerializableTutor extends Tutor {
    ...
    public void writeToFile(Person person) {
        try {
            ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(FILE_OBJECT_DATA));
    ...
    public Person readFromFile() {
        try {
            ObjectInputStream ois = new ObjectInputStream(new FileInputStream(FILE_OBJECT_DATA));
